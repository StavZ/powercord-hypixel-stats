...
function getSocialMedia (data) {
  ...
  if (links) {
    if (typeof links.TWITTER !== 'undefined') {
      media.push({ name: 'Twitter',
        link: links.TWITTER });
    }
    if (typeof links.YOUTUBE !== 'undefined') {
      media.push({ name: 'YouTube',
        link: links.YOUTUBE });
    }
    if (typeof links.INSTAGRAM !== 'undefined') {
      media.push({ name: 'Instagram',
        link: links.INSTAGRAM });
    }
    if (typeof links.TWITCH !== 'undefined') {
      media.push({ name: 'Twitch',
        link: links.TWITCH });
    }
    if (typeof links.MIXER !== 'undefined') {
      media.push({ name: 'Mixer',
        link: links.MIXER });
    }
    if (typeof links.HYPIXEL !== 'undefined') {
      media.push({ name: 'Hypixel',
        link: links.HYPIXEL });
    }
    if (typeof links.DISCORD !== 'undefined') {
      media.push({ name: 'Discord',
        link: links.DISCORD });
    }
  }
  return media;
